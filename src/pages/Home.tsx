    ...
    <div>
      ...
      <section className="py-16 md:py-24 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {[
              { id: 1, title: "Trisalex Painting", src: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
              { id: 2, title: "Trisalex Painting", src: "https://images.unsplash.com/photo-1513694203232-719a280e022f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
              { id: 3, title: "Trisalex Painting", src: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" }
            ].map((vid) => (
              <motion.div
                key={vid.id}
                variants={fadeInUp}
